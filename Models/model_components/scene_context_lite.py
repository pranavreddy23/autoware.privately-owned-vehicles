...
class SceneContextLite(nn.Module):
    def __init__(self):
        super(SceneContextLite, self).__init__()
        # Standard
        self.GeLU = nn.GELU()
        ...
        self.context_layer_3 = nn.Conv2d(1, 512, 3, 1, 1)
        self.context_layer_4 = nn.Conv2d(512, 1280, 3, 1, 1)
