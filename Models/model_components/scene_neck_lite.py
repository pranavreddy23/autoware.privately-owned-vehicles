...
class SceneNeckLite(nn.Module):
    def __init__(self):
        super(SceneNeckLite, self).__init__()
        # Standard
        self.GeLU = nn.GELU()
        ...
        self.decode_layer_0_pointwise = nn.Conv2d(1280, 768, 1)
        self.decode_layer_0_depthwise = nn.Conv2d(768, 768, 3, padding=1, groups=768)
        self.decode_layer_1 = nn.Conv2d(768, 768, 3, 1, 1)

        self.skip_link_layer_1 = nn.Conv2d(40, 768, 1)
        self.decode_layer_2_pointwise = nn.Conv2d(768, 512, 1)
        ...
        self.decode_layer_4_pointwise = nn.Conv2d(512, 512, 1)
        self.decode_layer_4_depthwise = nn.Conv2d(512, 512, 3, padding=1, groups=512)
