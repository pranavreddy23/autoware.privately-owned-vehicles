...
The current AutoSeg release comprises 5 perceptual tasks performed by different sub-network experts, these include: SceneSeg, ObjectInsta, LanesDet, PathDet, and DiversionDet.
