...
The current AutoSeg release comprises 4 perceptual tasks performed by different sub-network experts, these include: SceneSeg, ObjectSeg, LanesSeg, and PathSeg.
