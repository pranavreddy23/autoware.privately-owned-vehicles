...
The current AutoSeg release comprises 4 perceptual tasks performed by different sub-network experts, these include: SceneSeg, ObjectInsta, LanesDet, PathDet, and DiversionDet.
