...
The current AutoSeg release comprises 5 perceptual tasks performed by different sub-neural-network experts, these include: SceneSeg, SuperDepth, LaneDet, PathDet, and DiversionDet.
